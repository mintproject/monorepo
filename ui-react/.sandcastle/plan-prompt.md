...
All of these issues are scoped to the **`ui-react/`** subdirectory of the mint
monorepo (a React 18 + Vite app). When reasoning about file overlap below,
reason about files under `ui-react/`.
