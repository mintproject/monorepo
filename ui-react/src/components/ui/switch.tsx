/**
 * Switch — a lightweight accessible toggle.
 *
 * Implemented as a plain button with role="switch" (no Radix dependency) so the
 * register form can offer an on/off control without pulling in a new package.
 */
