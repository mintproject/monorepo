...
problem statement event relationships using the anonymous role, including the
ETL contract ordering fields used by the UI. This step does not apply seeds or
run ETL.
