...
2026-09-12 -- repository change (etl/ removed) -- updated [[variable-presentation]] so the column-to-predicate citation says etl/extract.py is no longer in the checkout and names `git log -- etl/extract.py` as the way to read it; no concept content changed; [[index]] unchanged
