...
# Automates docs/migration-testing.md: restore prod backup, apply migrations
# in two passes (schema -> ETL -> FK backfill), apply metadata.
#
# Usage:
#   ./scripts/test-migration-local.sh [trig-path] [sql-backup-path] [namespace]
#
# Defaults:
