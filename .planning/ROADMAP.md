...
Plans:
- [ ] 10-00-PLAN.md — DB migrations: drop execution.model_id, repoint execution_data_binding FK
- [ ] 10-01-PLAN.md — Fix breaking GraphQL queries + update execution adapter functions
